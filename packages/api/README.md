...
- Making requests to the SeaCoin Blockchain RPC.
...
import Client, { Wallet } from '@sea-network/api'; // or from "../seacoin-blockchain/seacoin-blockchain-gui/packages/api";
...
(async () => {
  const client = new Client({
    ...
    // key and crt files should be in your homedir in: .sea/mainnet/config/ssl/daemon/
