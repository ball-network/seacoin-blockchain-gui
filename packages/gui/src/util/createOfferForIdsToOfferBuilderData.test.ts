...
describe('createOfferForIdsToOfferBuilderData', () => {
  ...
  describe('when offering XSEA for CAT', () => {
    it('should return a valid offer builder data object', () => {
      ...
      seaCore.mojoToSea.mockReturnValue(new BigNumber(111.555));
      seaCore.mojoToCAT.mockReturnValue(new BigNumber(600));
  ...
  describe('when offering a CAT for XSEA', () => {
    it('should return a valid offer builder data object', () => {
      const calledLookupByWalletIdWithIds: string[] = [];
      const assetIdMapEntriesByWalletId: Record<string, AssetIdMapEntry> = {
        1: {
      ...
      seaCore.mojoToSea.mockReturnValue(new BigNumber(2));
      seaCore.mojoToCAT.mockReturnValue(new BigNumber(1.234));
  ...
  describe('when offering XSEA for an NFT', () => {
    it('should return a valid offer builder data object', () => {
      const calledLookupByWalletIdWithIds: string[] = [];
      const assetIdMapEntriesByWalletId: Record<string, AssetIdMapEntry> = {
        1: {
      ...
      seaCore.mojoToSea.mockReturnValue(new BigNumber(3));
  ...
  describe('when the offered asset is for an unknown wallet type', () => {
    it('should ignore the unknown wallet assets', () => {
      ...
      seaCore.mojoToSea.mockReturnValue(new BigNumber(0.5));
  ...
  describe('when lookupByWalletId throws', () => {
    ...
    it('should ignore the asset that caused the error', () => {
      ...
      seaCore.mojoToSea.mockReturnValue(new BigNumber(5));
      seaCore.mojoToCAT.mockReturnValue(new BigNumber(1000));
