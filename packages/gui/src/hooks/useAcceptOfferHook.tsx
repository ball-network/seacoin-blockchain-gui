import type { OfferSummaryRecord, Wallet } from '@sea-network/api';
import { useTakeOfferMutation } from '@sea-network/api-react';
import { AlertDialog, seaToMojo, useOpenDialog, useShowError } from '@sea-network/core';
...
export default function useAcceptOfferHook(): [AcceptOfferHook] {
  ...
  async function acceptOffer(
    ...
    const feeInMojos: BigNumber = fee ? seaToMojo(fee) : new BigNumber(0);
