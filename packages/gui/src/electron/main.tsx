...
import { NFTInfo } from '@sea-network/api';
...
import AppIcon from '../assets/img/sea64x64.png';
import About from '../components/about/About';
import { i18n } from '../config/locales';
import seaEnvironment from '../util/seaEnvironment';
...
// Set the userData directory to its location within SEA_ROOT/gui
setUserDataDir();
...
const ensureCorrectEnvironment = () => {
  ...
  if (!seaEnvironment.guessPackaged() && !('VIRTUAL_ENV' in process.env)) {
    app.quit();
    return false;
  }
...
function getMenuTemplate() {
    ...
    },
    {
      ...
      submenu: [
        ...
        },
        {
          ...
          click: () => {
            openExternal('https://discord.gg/sea');
          },
        },
        {
          label: i18n._(/* i18n */ { id: 'Follow on Twitter' }),
          click: () => {
            openExternal('https://twitter.com/sea_project');
          },
        },
      ],
    },
  ...
  if (process.platform === 'darwin') {
    // SeaCoin Blockchain menu (Mac)
    template.unshift({
      label: i18n._(/* i18n */ { id: 'Sea' }),
      submenu: [
        {
          label: i18n._(/* i18n */ { id: 'About SeaCoin Blockchain' }),
          click: () => {
            openAbout();
          },
        },
