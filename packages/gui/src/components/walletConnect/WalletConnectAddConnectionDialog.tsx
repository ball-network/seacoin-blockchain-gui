import { useGetKeysQuery, useGetLoggedInFingerprintQuery, usePrefs } from '@sea-network/api-react';
import {
  ButtonLoading,
  DialogActions,
  Flex,
...
import HeroImage from './images/walletConnectToSea.svg';
...
export default function WalletConnectAddConnectionDialog(props: WalletConnectAddConnectionDialogProps) {
  ...
  const mainnet = useCurrencyCode() === 'XSEA';
