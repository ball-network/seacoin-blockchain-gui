import { Button, Flex } from '@sea-network/core';
        ...
        <DialogContent>
          <Flex flexDirection="column" gap={1}>
            <Typography variant="body2" color="textSecondary">
              <Trans>
                The Sea application and its services are using different versions. Some functionality may not be behave
                properly as a result.
                <br />
                <br />
                Sea services version: {backV}
                <br />
                Sea application version: {guiV}
                <br />
                <br />
                It is recommended that you quit the Sea application and stop all Sea services.
              </Trans>
            </Typography>
          </Flex>
        </DialogContent>
