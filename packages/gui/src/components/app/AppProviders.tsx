...
import WalletConnectProvider, { WalletConnectSeaProjectId } from '../walletConnect/WalletConnectProvider';
                        ...
                        <AddressBookProvider>
                          <OffersProvider>
                            <NotificationsProvider>
                              <WalletConnectProvider projectId={WalletConnectSeaProjectId}>
