import { Color, Flex, useMode, Mode, useDarkMode, useAuth, Tooltip } from '@sea-network/core';
import { WalletConnections, WalletStatus, WalletReceiveAddressField } from '@sea-network/wallets';
