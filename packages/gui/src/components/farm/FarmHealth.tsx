...
import { Flex, Link, StateIndicator, State, Tooltip, useCurrencyCode } from '@sea-network/core';
      ...
      <Box>
        ...
        <p>
          ...
          <StyledTableForTooltip>
            ...
            <tr>
              <Link target="_blank" href="https://docs.seacoin.vip/faq/#why-does-my-sea-farm-say-missing-signage-points">
