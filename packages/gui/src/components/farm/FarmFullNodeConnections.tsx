import type { Connection } from '@sea-network/api';
import { ServiceName } from '@sea-network/api';
import { useGetFarmerFullNodeConnectionsQuery, useService } from '@sea-network/api-react';
import { Table, Card, FormatBytes, FormatConnectionStatus } from '@sea-network/core';
