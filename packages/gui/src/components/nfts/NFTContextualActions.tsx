...
import { useSetNFTStatusMutation, useLocalStorage } from '@sea-network/api-react';
import { AlertDialog, DropdownActions, MenuItem, useOpenDialog, isValidURL } from '@sea-network/core';
import {
  Burn as BurnIcon,
