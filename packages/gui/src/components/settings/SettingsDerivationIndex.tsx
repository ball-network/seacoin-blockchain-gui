import { SyncingStatus } from '@sea-network/api';
import { useExtendDerivationIndexMutation, useGetCurrentDerivationIndexQuery } from '@sea-network/api-react';
import { AlertDialog, ButtonLoading, Flex, Form, TextField, useOpenDialog } from '@sea-network/core';
import { useWalletState } from '@sea-network/wallets';
