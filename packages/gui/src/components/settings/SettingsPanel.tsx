...
import { useGetKeyringStatusQuery } from '@sea-network/api-react';
import {
  AlertDialog,
  Button,
  Color,
          ...
          <Flex gap={1} alignItems="center">
            ...
            <TooltipIcon>
              <Trans>
                ...
                number is generally higher if you have a lot of transactions or canceled offers for XSEA, CATs, or NFTs.
