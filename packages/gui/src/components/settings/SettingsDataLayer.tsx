import { Flex, SettingsHR, SettingsSection, SettingsTitle, SettingsText } from '@sea-network/core';
    ...
    <Grid container style={{ maxWidth: '624px' }} gap={3}>
      <Grid item>
        <Flex flexDirection="column" gap={1}>
          ...
          <SettingsText>
            <Trans>
              DataLayer enables rich data to be stored on mirrored databases that can be verified using the Sea
              Blockchain.
            </Trans>
          </SettingsText>
        </Flex>
