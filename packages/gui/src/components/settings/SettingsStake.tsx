import { useGetAutoWithdrawStakeQuery, useSetAutoWithdrawStakeMutation } from '@sea-network/api-react';
import { Flex, Form, ButtonLoading, Fee, SettingsLabel, seaToMojo, mojoToSea, toExponential } from '@sea-network/core';
...
export default function SettingsStake(props) {
  ...
  const autoWithdrawStakeFee = toExponential(
    withdrawStake?.txFee ? mojoToSea(withdrawStake.txFee).toNumber() : 0
  );
