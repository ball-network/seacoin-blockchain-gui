import { Connection } from '@sea-network/api';
import { useGetFullNodeConnectionsQuery } from '@sea-network/api-react';
import { Card, FormatBytes, FormatLargeNumber, IconButton, Loading, Table, useOpenDialog } from '@sea-network/core';
