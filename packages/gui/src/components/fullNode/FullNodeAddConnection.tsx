import { useOpenFullNodeConnectionMutation } from '@sea-network/api-react';
import { Button, ButtonLoading, DialogActions, Flex, Form, TextField, useShowError } from '@sea-network/core';
