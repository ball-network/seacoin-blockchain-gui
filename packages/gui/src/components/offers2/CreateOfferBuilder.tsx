...
import { useGetWalletsQuery, useCreateOfferForIdsMutation } from '@sea-network/api-react';
import { Flex, ButtonLoading, useOpenDialog, Loading } from '@sea-network/core';
