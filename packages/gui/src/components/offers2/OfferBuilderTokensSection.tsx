...
import { useGetWalletsQuery } from '@sea-network/api-react';
import { Flex, Loading, catToMojo, mojoToCATLocaleString } from '@sea-network/core';
import { Tokens } from '@sea-network/icons';
...
export default function OfferBuilderTokensSection(props: OfferBuilderTokensSectionProps) {
  ...
  return (
    <OfferBuilderSection
      ...
      subtitle={<Trans>Sea Asset Tokens (CATs) are tokens built on top of XSEA</Trans>}
