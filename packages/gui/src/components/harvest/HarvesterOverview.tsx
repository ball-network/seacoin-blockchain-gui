import { useGetHarvestersQuery, useGetNewFarmingInfoQuery } from '@sea-network/api-react';
import { Flex, FormatBytes, FormatLargeNumber, CardSimple } from '@sea-network/core';
