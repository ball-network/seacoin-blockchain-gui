import { toBech32m, fromBech32m } from '@sea-network/api';
import { useGetCurrentAddressQuery, useSendNotificationMutation } from '@sea-network/api-react';
import {
  AlertDialog,
  Amount,
  ButtonLoading,
...
export default function NotificationSendDialog(props: NotificationSendDialogProps) {
  ...
  async function handleSubmit(values: NotificationSendDialogFormData) {
    ...
    const amountMojos = seaToMojo(amount);
    const feeMojos = seaToMojo(fee);
                  ...
                  <Grid container spacing={3}>
                    ...
                    <Grid item xs={12}>
                      <EstimatedFee
                        ...
                        txType={FeeTxType.walletSendXSEA}
