import { useRefreshPlotsMutation } from '@sea-network/api-react';
import { Button, CardHero, Flex, Link, useOpenDialog } from '@sea-network/core';
import { Plots } from '@sea-network/icons';
