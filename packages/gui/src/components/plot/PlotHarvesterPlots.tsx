import { type Plot } from '@sea-network/api';
import { useGetHarvesterPlotsValidQuery, useGetHarvesterQuery } from '@sea-network/api-react';
import { Address, TableControlled, Flex, FormatBytes, Tooltip, StateColor } from '@sea-network/core';
