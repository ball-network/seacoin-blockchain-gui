import { defaultPlotter, toBech32m, fromBech32m } from '@sea-network/api';
import { useStartPlottingMutation, useCreateNewPoolWalletMutation } from '@sea-network/api-react';
import { Back, useShowError, ButtonLoading, Flex, Form } from '@sea-network/core';
...
export default function PlotAddForm(props: Props) {
  ...
  const methods = useForm<FormData>({
    defaultValues: defaultsForPlotter(PlotterName.SEAPOS),
  });
