import type { PlotNFT, PlotNFTExternal } from '@sea-network/api';
import { useGetPoolLoginLinkQuery } from '@sea-network/api-react';
import { Button, CopyToClipboard, Flex, Link, Loading } from '@sea-network/core';
