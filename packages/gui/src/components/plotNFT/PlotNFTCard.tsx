import { useDeleteUnconfirmedTransactionsMutation } from '@sea-network/api-react';
import {
  Button,
  Color,
  TooltipTypography,
...
import { Plot as PlotIcon } from '@sea-network/icons';
...
export default function PlotNFTCard(props: Props) {
  ...
  const rows = [
    ...
    isSelfPooling && {
      ...
      value: <UnitFormat value={mojoToSeaLocaleString(balance)} state={State.SUCCESS} />,
    },
    {
      key: 'plotsCount',
