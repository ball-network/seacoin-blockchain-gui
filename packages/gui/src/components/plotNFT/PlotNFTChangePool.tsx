import { useGetPlotNFTsQuery, usePwSelfPoolMutation, usePwJoinPoolMutation } from '@sea-network/api-react';
import { Flex, State, Loading, StateTypography } from '@sea-network/core';
