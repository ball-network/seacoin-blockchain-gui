import type { UnconfirmedPlotNFT } from '@sea-network/api';
import { useGetTransactionQuery } from '@sea-network/api-react';
import { Flex, Link, Loading } from '@sea-network/core';
