import { WalletType, type Wallet } from '@sea-network/api';
import { useGetCatListQuery } from '@sea-network/api-react';
import { Flex, TooltipIcon, useCurrencyCode } from '@sea-network/core';
import { CrCat } from '@sea-network/icons';
