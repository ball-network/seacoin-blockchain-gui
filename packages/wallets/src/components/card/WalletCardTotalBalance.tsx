import { useGetWalletBalanceQuery, useGetCurrentDerivationIndexQuery } from '@sea-network/api-react';
import { CardSimple, Flex, TooltipIcon } from '@sea-network/core';
            ...
            <Flex alignItems="center" gap={1}>
              ...
              <TooltipIcon>
                <Trans>
                  ...
                  number is generally higher if you have a lot of transactions or canceled offers for XSEA, CATs, or
