...
import { useSetCATNameMutation, useGetCatListQuery } from '@sea-network/api-react';
import { Flex, Loading, MenuItem, useOpenDialog } from '@sea-network/core';
import { Offers as OffersIcon } from '@sea-network/icons';
