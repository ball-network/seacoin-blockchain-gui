import type { CATToken } from '@sea-network/api';
import { SyncingStatus } from '@sea-network/api';
import { useGetWalletsQuery, useAddCATTokenMutation, useGetCatListQuery } from '@sea-network/api-react';
import { Back, Flex, Loading, useShowError } from '@sea-network/core';
