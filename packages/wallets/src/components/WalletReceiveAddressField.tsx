import { useGetCurrentAddressQuery, useGetNextAddressMutation } from '@sea-network/api-react';
import { Color, Flex, Loading, truncateValue, useColorModeValue } from '@sea-network/core';
import { Reload } from '@sea-network/icons';
