import { Connection, ServiceConnectionName } from '@sea-network/api';
import { useGetWalletConnectionsQuery } from '@sea-network/api-react';
import { Card, FormatBytes, Loading, Table } from '@sea-network/core';
