...
import type { NFTRecoverInfo } from '@sea-network/api';
import {
  useLocalStorage,
        ...
        <Grid spacing={2} alignItems="stretch" container>
          ...
          <Grid xs={12} md={4} item>
            <CardSimple
              ...
              value={nftData?mojoToSeaLocaleString(nftData.totalAmount, locale):"-"}
            />
          </Grid>
          <Grid xs={12} md={4} item>
            <CardSimple
              ...
              value={nftData?mojoToSeaLocaleString(nftData.balanceAmount, locale):"-"}
            />
          </Grid>
          <Grid xs={12} md={4} item>
            <CardSimple
              ...
              value={nftData?mojoToSeaLocaleString(nftData.recordAmount, locale):"-"}
            />
          </Grid>
        </Grid>
        </Form>
