import { TransactionType } from '@sea-network/api';
import type { Transaction } from '@sea-network/api';
import { useGetAutoClaimQuery, useGetTimestampForHeightQuery, useGetHeightInfoQuery } from '@sea-network/api-react';
import { useTrans, Button } from '@sea-network/core';
