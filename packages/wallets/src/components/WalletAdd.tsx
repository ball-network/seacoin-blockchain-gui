import { useGenerateMnemonicMutation, useAddPrivateKeyMutation } from '@sea-network/api-react';
import { ButtonLoading, Form, TextField, Flex, Loading, Logo, useAuth, useShowError } from '@sea-network/core';
