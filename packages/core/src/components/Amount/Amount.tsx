...
import seaToMojo from '../../utils/seaToMojo';
...
export default function Amount(props: AmountProps) {
  ...
  const isSeaCurrency = ['XSEA', 'TXSEA'].includes(currencyCode);
  const mojo = isSeaCurrency ? seaToMojo(correctedValue) : catToMojo(correctedValue);
    ...
    <FormControl variant={variant} fullWidth={fullWidth}>
      <TextField
        ...
        InputProps={{
          ...
          inputProps: {
            decimalScale: isSeaCurrency ? 12 : 3,
            'data-testid': dataTestid,
          },
