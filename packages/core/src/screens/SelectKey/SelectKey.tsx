import type { KeyData } from '@sea-network/api';
import {
  usePrefs,
...
import { SeaBlack, Coins } from '@sea-network/icons';
        ...
        {isLoadingPublicKeys ? (
          ...
          <>
            ...
            <Flex alignItems="center" flexDirection="column">
              ...
              >
                <Trans>Create a new wallet key to get started with Sea.</Trans>
              </Typography>
              <Button
